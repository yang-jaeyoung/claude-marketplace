...
> **업데이트**: **GUIDELINES.md/AGENTS.md 자동 생성**, OMC 통합, QA Loop, UltraQA, Research Mode, 병렬 실행 강화, Autonomous Loop, Gemini CLI 리뷰 통합, Tidy First 방법론, Git Worktree 지원
...
1. [빠른 시작](#-빠른-시작)
2. [핵심 개념](#-핵심-개념)
3. [초기화 고급 기능](#-초기화-고급-기능-new) **(NEW v1.9.0)**
4. [OMC 통합](#-omc-통합)
5. [QA Loop & UltraQA](#-qa-loop--ultraqa)
