...
allowed-tools:
  ...
  - Glob
  - Bash
  - mcp__krx-quant__krx_collect
  - mcp__krx-quant__factor_analyze
  - mcp__krx-quant__stock_screen
  - mcp__krx-quant__browser_scrape
---

# KRX-Quant Ultra 분석 모드

모든 krx-quant 기능을 최대 역량으로 활용하여 심층 종합분석을 수행합니다.
