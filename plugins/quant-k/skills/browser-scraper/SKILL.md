...
Task(
  ...
  5. Save to .omc/quant-k/scraper/{session-id}/data-page-1.json
...
Task(
  ...
  .omc/quant-k/scraper/{session-id}/data-page-{N}.json
  """
)
```
...
**Deliverable:** Exported files in `.omc/quant-k/scraper/{session-id}/`
...
Task(
  ...
  Input: .omc/quant-k/scraper/scraper-20260129/combined.json
...
```json
{
  "browser-scraper": {
    ...
    "timeout": 300000,
    "exportFormats": ["json", "csv", "md"],
    "sessionDirectory": ".omc/quant-k/scraper",
...
| `sessionDirectory` | string | `.omc/quant-k/scraper` | Session storage path |
...
**Output:**
```
.omc/quant-k/scraper/scraper-20260129-103045/
